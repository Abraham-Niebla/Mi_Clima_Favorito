...
fun getUV(uv: Double): String{
    return when {
        uv in 0.0..2.9      -> stringResource(R.string.uv_low)
        uv in 3.0..5.9      -> stringResource(R.string.uv_moderate)
        uv in 6.0..7.9      -> stringResource(R.string.uv_high)
        uv in 8.0..10.9     -> stringResource(R.string.uv_very_high)
